...
/**
 * This class is a basic plotting class using the Java AWT interface. It has basic features which
 * allow the user to plot multiple graphs on one figure, control axis dimensions, and specify
 * colors.
 * 
 * This is by all means not an extensive plotter, but it will help visualize data very quickly and
 * accurately. If a more robust plotting function is required, the user is encouraged to use Excel
 * or Matlab. The purpose of this class is to be easy to use with enought automation to have nice
 * graphs with minimal effort, but give the user control over as much as possible, so they can
 * generate the perfect chart.
 * 
 * The plotter also features the ability to capture screen shots directly from the right-click menu,
 * this allows the user to copy and paste plots into reports or other documents rather quickly.
 * 
...
class FalconLinePlot extends JPanel implements ClipboardOwner {
    ...
    /**
     * Constructor which Plots chart based on provided x and y data. X and Y arrays must be of the
     * same length.
     * 
     ...
     * 
     * @param data is a 2D array of doubles of size Nx2 or 2xN. The plot assumes X is the first
     *        dimension, and y data is the second dimension.
     */
    ...
    /**
     * Constructor which plots charts based on provided x and y axis data in a single two
     * dimensional array.
     * 
     * @param data is a 2D array of doubles of size Nx2 or 2xN. The plot assumes X is the first
     *        dimension, and y data is the second dimension.
     * @param lineColor is the color the user wishes to be displayed for the line connecting each
     *        datapoint
     * @param markerColor is the color the user which to be used for the data point. Make this null
    ...
    /**
     * Constructor which plots charts based on provided x and y axis data provided as separate
     * arrays. The user can also specify the color of the adjoining line. Data markers are not
     * displayed.
     * 
     * @param xData is an array of doubles representing the X-axis values of the data to be plotted.
     * @param yData is an array of double representing the Y-axis values of the data to be plotted.
    ...
    /**
     * Constructor which plots charts based on provided x and y axis data, provided as separate
     * arrays. The user can also specify the color of the adjoining line and the color of the
     * datapoint maker.
     * 
     * @param xData is an array of doubles representing the X-axis values of the data to be plotted.
     * @param yData is an array of double representing the Y-axis values of the data to be plotted.
     ...
     * 
     * @param yData is a array of doubles representing the Y-axis values of the data to be plotted.
     * @param color is the color the user wishes to be displayed for the line connecting each
     *        datapoint
     */
    ...
    private void menu(JFrame g, final FalconLinePlot p) {
        ...
        item.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                /*
                 * try { //no idea what this does and it causes compile errors. taking out and
                 * moving on Robot robot = new Robot(); Dimension screenSize =
                 * Toolkit.getDefaultToolkit().getScreenSize(); Rectangle screen = new Rectangle(
                 * screenSize ); BufferedImage i = robot.createScreenCapture( screen );
                 * TransferableImage trans = new TransferableImage( i ); Clipboard c =
                 * Toolkit.getDefaultToolkit().getSystemClipboard(); c.setContents( trans, p); }
                 * catch ( AWTException x ) { x.printStackTrace(); System.exit( 1 ); }
                 */
