...
public abstract class casserolePathExecutor {
    ...
    /**
     * This method gets called as soon as playback has finished. Use it to clean up any
     * user-specific things needed for autonomous.
     */
    ...
    public abstract void setAutonomousDrivetrainSpeeds(double left_motor_vel, double right_motor_vel,
            double pp_des_heading);
