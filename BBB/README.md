...
Set a static IP address of 10.17.36.9, with the default gateway pointing to the router (usually 10.17.36.1)

    ls -la /var/lib/connman/
    cd /var/lib/connman/ethernet_[xx]
    more settings
    cd /usr/lib/connman/test
    ./set-ipv4-method ethernet_[xx]_cable manual 10.17.36.9 255.255.255.0 10.17.36.1
    reboot
